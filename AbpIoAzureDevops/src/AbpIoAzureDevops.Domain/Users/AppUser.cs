...
namespace AbpIoAzureDevops.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpIoAzureDevopsDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpIoAzureDevopsEfCoreEntityExtensionMappings to extend the IdentityUser entity
